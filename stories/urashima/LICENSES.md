...
`base/kamishibai-4.0.sb3`は、TM Kamishibai `4.0.0-rc.8`の固定release source identity `sha256:8edbc02a06b3770cce0a89cf658367df129d974d53f401258b69f0713762014a`から生成したruntime baseです。`urashima-4.0.sb3`と`../my-urashima/my-urashima-4.0.sb3`は、このbaseへtag commit `29c0deadcb98badf94a0244c479ca896dc71f842`のビルダーと`@kubohiroya/sb3-toolchain@0.8.0`を適用して生成します。統合されたJavaScriptの冒頭には、各機能拡張ソースの名称、著作権表示、ライセンス表示を保持しています。浦島太郎のポーズモデルの取得元と各ファイルの固定SHA-256は`dsl4-inputs.lock.json`に記録しています。my-urashima 4.0版のPrincessコスチュームには、前述のCC BY-SA 4.0が適用されます。
