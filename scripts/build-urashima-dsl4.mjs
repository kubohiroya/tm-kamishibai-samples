...
function inspectProject(sb3Bytes) {
  ...
  assert.equal(typeof project.extensionURLs.kubohiroyakamishibai4, 'string');
  assert(project.extensionURLs.kubohiroyakamishibai4.startsWith('data:'));
