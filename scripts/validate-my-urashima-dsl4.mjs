...
function uncommentExactlyOnce(source, line) {
...
function createVariant(source, poseCount, poseCandidate) {
  let variant = source;
...
export async function validateMyUrashimaDsl4Workshop() {
  ...
  const variants = [
    ['initial', source],
    ['two-poses', createVariant(source, 2, poseCandidates[0])],
    ['three-poses', createVariant(source, 3, poseCandidates[1])],
    ['four-poses', createVariant(source, 4, poseCandidates[2])],
  ];
