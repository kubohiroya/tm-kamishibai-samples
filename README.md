...
- `base/kamishibai-4.0.sb3`: DSL 4.0.0-rc.2の固定release sourceから生成し、サイズとSHA-256を固定した`generic`ベース
...
- `tutorial-4.0.sb3` / starter ZIP / addition kit ZIP / `web-4.0/index.html`: 4.0.0-rc.2で再現・検証して公開するDSL 4.0チュートリアル成果物
